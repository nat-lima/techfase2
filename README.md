...
- **`data/`**: O algoritmo escrito no notebook Jupyter salva o resultado proveniente do site https://sistemaswebb3-listados.b3.com.br/indexPage/day/IBOV?language=pt-br num arquivo formato .csv.
